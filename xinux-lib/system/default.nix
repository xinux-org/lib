...
let
  ...
  user-systems-root = xinux-lib.fs.get-xinux-file "systems";
...
in
{
  system = rec {
    ...
    get-inferred-system-name =
      path:
      if xinux-lib.path.has-file-extension "nix" path then
        xinux-lib.path.get-parent-directory path
      else
        baseNameOf path;
    ...
    get-target-systems-metadata =
      target:
      let
        systems = xinux-lib.fs.get-directories target;
    ...
    create-system =
      ...
      let
        ...
        home-system-modules = xinux-lib.home.create-home-system-modules homes;
        home-manager-module =
    ...
    create-systems =
      ...
      let
        targets = xinux-lib.fs.get-directories user-systems-root;
        target-systems-metadata = concatMap get-target-systems-metadata targets;
        user-nixos-modules = xinux-lib.module.create-modules {
          src = "${user-modules-root}/nixos";
        };
        user-darwin-modules = xinux-lib.module.create-modules {
