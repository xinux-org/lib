...
in
{
  overlay = {
    ...
    create-overlays-builder =
      ...
      channels:
      let
        user-overlays = xinux-lib.fs.get-default-nix-files-recursive src;
        create-overlay =
          overlay:
          import overlay (
    ...
    create-overlays =
      ...
      let
        ...
        user-packages = xinux-lib.fs.get-default-nix-files-recursive packages-src;
        ...
        default-overlay =
          ...
          let
            ...
            merged-results = xinux-lib.attrs.merge-shallow-packages (
